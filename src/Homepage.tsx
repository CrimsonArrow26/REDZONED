...
function HomePage() {
  ...
  const mappedZones = zones.map(zone => ({
    ...zone,
    risk_level: getZoneRiskLevel(zone.incident_count) as "high" | "medium" | "low"
  }));

  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-red-50">
      {/* Hero Section */}
      <div className="max-w-5xl mx-auto mt-28 mb-12">
        {/* The entire hero card slides up on load */}
        <motion.div
          className="relative bg-gradient-to-br from-gray-900 to-gray-800 rounded-3xl p-8 shadow-2xl overflow-hidden"
        ...
        >
          ...
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300 text-sm">1km radius crime monitoring</p>
            </div>
            {/* Center */}
            <div className="text-center">
              <div className="relative mb-4">
              ...
              <h3 className="text-white font-semibold mb-2">Dynamic RedZones</h3>
              <p className="text-gray-300 text-sm">Animated danger visualization</p>
            </div>
            {/* Right */}
            <div className="text-center">
              <div className="relative mb-4">
              ...
              <h3 className="text-white font-semibold mb-2">Instant SOS</h3>
              <p className="text-gray-300 text-sm">Emergency contact alerts</p>
            </div>
          </div>
          ...
          <div className="flex justify-center items-center space-x-6 mt-8 pt-6 border-t border-gray-700">
            ...
            <div className="flex items-center space-x-2 text-gray-300">
              ...
              <span className="text-sm">Daily News</span>
            </div>
            <div className="flex items-center space-x-2 text-gray-300">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          ...
          >
            Discover how RedZone's advanced features work together to create an unparalleled personal safety experience
          </motion.p>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <motion.p
              ...
              viewport={{ once: true, amount: 0.5 }}
            >
              Our dynamic map interface provides real-time visualization of safety
              zones, helping you make informed decisions about your routes and
              destinations.
            </motion.p>
          </div>
                    ...
                    .map(zone => (
                      <React.Fragment key={zone.id}>
                        <Circle
                          ...
                          radius={riskRadius[zone.risk_level as keyof typeof riskRadius]}
                          pathOptions={{
                            color: riskColors[zone.risk_level as keyof typeof riskColors],
                            fillOpacity: 0.2
                          }}
                        />
                        <Marker
                        ...
                        >
                          <Popup>
                            <div>
                              ...
                              <br />
                              Risk:{" "}
                              <span style={{ color: riskColors[zone.risk_level as keyof typeof riskColors] }}>
                                {zone.risk_level.charAt(0).toUpperCase() + zone.risk_level.slice(1)} Risk
                              </span>
                              <br />
                              <strong>Incidents:</strong> {zone.incident_count}
                              <br />
                    ...
                    >
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-500 text-xs">{zone.updated || "Updated recently"}</p>
                          <p className="text-base font-bold text-blue-700 mt-1">Incidents: {zone.incident_count}</p>
                        </div>
                      </div>
                      <span
                      ...
                      >
                        {zone.risk_level.charAt(0).toUpperCase() + zone.risk_level.slice(1)}
                      </span>
                    </motion.li>
                  ))}
                </ul>
